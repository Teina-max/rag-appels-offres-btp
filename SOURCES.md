...
Ce dépôt embarque un corpus de **pièces écrites de marchés publics de travaux** (DCE — Dossiers de Consultation des Entreprises) à des fins de démonstration et d'évaluation d'un système RAG.
